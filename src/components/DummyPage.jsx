    ...
    try {
      ...
      if (userRow) {
        ...
        if (driveImageUrl && driveImageUrl.includes("drive.google.com")) {
          ...
          imageUrl = Array.isArray(possibleUrls)
            ? possibleUrls[0]
            : possibleUrls;
    ...
    try {
      ...
      iframe.onload = () => {
        try {
          ...
          console.log(
            "Response received in iframe",
            iframeContent.body.innerText
          );
          ...
          console.log(
            "Couldn't access iframe content due to CORS, but form was submitted"
          );
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-indigo-200 text-center max-w-2xl">
            Manage your professional profile and personal information in one
            place
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center justify-center">
            ...
            <span className="mx-4 text-indigo-200 text-sm">
              Powered by Botivate
            </span>
            <div className="h-px w-16 bg-indigo-300/30"></div>
          </div>
          <p className="mt-4 text-indigo-300/60 text-sm">
            © 2025 SalonPro. All rights reserved.
          </p>
        </div>
      </div>
